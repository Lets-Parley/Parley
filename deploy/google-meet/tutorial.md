...
add-ons API exposes; three steps have no API and stay manual console clicks,
...
The script prints three remaining steps and their console URLs:
...
2. A super administrator turns on, once per domain, "Allow users to install
...
Once App configuration is done, start a call at meet.google.com and open
**Meeting tools → Your add-ons** to try Parley yourself.
