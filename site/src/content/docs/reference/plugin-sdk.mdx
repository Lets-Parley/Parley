...
<VerifiedStamp version="unreleased" source={["sdk/plugin-sdk/src/host.js", "sdk/plugin-sdk/src/cli.js", "sdk/plugin-ui/parley.css", "internal/api/plugindev.go", "internal/plugin/describe.go"]} />
...
`capability` plus optional `scope`), and `kinds` for ceremonies the plugin
provides. Installing through the operator API still requires `grantsAccepted:
