...
<VerifiedStamp version="unreleased" source={["sdk/abi/v1.json", "internal/plugin/hostfn.go", "internal/plugin/cron.go", "internal/plugin/kv.go", "internal/plugin/kinds.go"]} />
