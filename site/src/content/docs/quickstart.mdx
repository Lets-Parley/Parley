...
buoy or cargo crate — or choose **Initials** to go back. The second row adds one
accessory on top — captain's hat, hard hat, eyepatch, halo, monocle or headset —
with **None** for a bare chip. The choice is saved when you close the dialog and
follows you into every room.
