...
Pin a version rather than `latest`. Run 0.2.2 or later: every earlier release
can be crashed remotely by a disconnecting client, and v0.1.0 additionally has a
room-code throttle bypass.
